    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col lg:flex-row h-[calc(100vh-80px)]">
        <div className="flex-1 flex items-center justify-center p-6 overflow-hidden">
          <div className="relative  w-[68dvh] h-[100vh] flex items-center justify-center">
            ...
            <div
              className={`relative transition-transform duration-300 overflow-hidden rounded-2xl max-w-full max-h-full ${
